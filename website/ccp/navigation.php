...
$htmlLinkStandardArray = array($htmlLinkResults, $htmlLinkTotalPoints, $htmlLinkEarnings, $htmlLinkEarningsChampionship, $htmlLinkKnockouts, $htmlLinkSummary, $htmlLinkWinners, $htmlLinkFinishes);

...
$htmlLinkTotalPoints = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("pointsTotal", "show"), -1, "Total pts", null);
$htmlLinkEarnings = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("earnings", "show"), -1, "Earnings", null);
$htmlLinkEarningsChampionship = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("earningsChampionship", "show"), -1, "Earnings (Championship)", null);
$htmlLinkKnockouts = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("knockouts", "show"), -1, "KOs", null);
$htmlLinkSummary = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("summary", "show"), -1, "Summary", null);
$htmlLinkWinners = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("winners", "show"), -1, "Winners", null);
$htmlLinkFinishes = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("finishes", "show"), -1, "Finishes", null);
$htmlLinkBounties = new HtmlLink(null, null, SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), "reports.php", null, array("reportId", "seasonSelection"), array("bounties", "show"), -1, "Bounties", null);

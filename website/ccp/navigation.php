...
$htmlLinkChampionship = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "championship.php", id: null, paramName: null, paramValue: null, tabIndex: -1, text: "Championship<br />Seating", title: null);
// $debug, $id, $items, $text
...
$htmlLinkBounties = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "reports.php", id: null, paramName: array("reportId", "seasonSelection"), paramValue: array("bounties", "show"), tabIndex: -1, text: "Bounties", title: null);
...
$htmlLinkBounties = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "top5.php", id: null, paramName: array("reportId", "navigation"), paramValue: array("bountiesForSeason", "Y"), tabIndex: -1, text: "Bounties", title: null);
...
$htmlLinkByYearByEarnings = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "reports.php", id: null, paramName: array("reportId", "sort"), paramValue: array("championship", "0 desc,2 desc"), tabIndex: -1, text: "By year by earnings", title: null);
$htmlLinkByNameByYear = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "reports.php", id: null, paramName: array("reportId", "sort"), paramValue: array("championship", "1 asc,0 desc"), tabIndex: -1, text: "By name by year", title: null);
$htmlLinkByNameByEarningsByYear = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "reports.php", id: null, paramName: array("reportId", "sort"), paramValue: array("championship", "1 asc,2 desc"), tabIndex: -1, text: "By name by earnings by year", title: null);
$htmlLinkByNameByEarnings = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "reports.php", id: null, paramName: array("reportId", "sort", "group"), paramValue: array("championship", "2 desc,1 asc", "true"), tabIndex: -1, text: "By name by earnings", title: null);
...
$htmlLinkTotalEarnings = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "top5.php", id: null, paramName: array("reportId", "navigation"), paramValue: array("earningsTotalForSeason", "Y"), tabIndex: -1, text: "Total earnings", title: null);
$htmlLinkAverageEarnings = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "top5.php", id: null, paramName: array("reportId", "navigation"), paramValue: array("earningsTotalForUser", "Y"), tabIndex: -1, text: "Avg earnings", title: null);
...
if (SessionUtility::getValue(SessionUtility::$OBJECT_NAME_ADMINISTRATOR) != 0) {
  ...
  $htmlLinkResultsDuring = new HtmlLink(accessKey: null, class: null, debug: SessionUtility::getValue(SessionUtility::$OBJECT_NAME_DEBUG), href: "manageResultsDuring.php", id: null, paramName: null, paramValue: null, tabIndex: -1, text: "Results - during", title: null);

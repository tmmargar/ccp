...
if (SessionUtility::getValue(SessionUtility::OBJECT_NAME_ADMINISTRATOR) != 0) {
  ...
  $htmlLinkGamesArray = array($htmlLinkNotifications,$htmlLinkSeasons,$htmlLinkTournaments,$htmlLinkTournamentAbsences,$htmlLinkRegistration,$htmlLinkBuyins,$htmlLinkResults,$htmlLinkSpecialType);

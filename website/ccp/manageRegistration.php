...
if ($mode == Constant::$MODE_VIEW) {
  ...
  $resultList = $databaseResult->getTournamentForRegistration(params: $params);
  if (count($resultList) > 0) {

      ...
      if (!$(this).hasClass('xdsoft_scroller_box')) {
        ...
        timeboxparent
          .on('scroll_element.xdsoft_scroller', function (event, percentage) {
            ...
            // Todd change to prevent negative margin top causing times to be hidden
            let offsetHeight = timebox[0].offsetHeight;
            if (offsetHeight < parentHeight) {
              offsetHeight = parentHeight;
            }
            timeboxTop = parseFloat(Math.abs((offsetHeight - parentHeight) * percentage).toFixed(4));

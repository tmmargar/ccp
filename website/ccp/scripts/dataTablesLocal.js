...
export const dataTable = {
  ...
  initializeCommon : function({tableSelector, aryColumns = null, aryOrder = [], aryRowGroup = false, autoWidth = false, paging = false, scrollCollapse = true, scrollResize = true, scrollY = "", searching = true} = {}) {
    $(tableSelector).DataTable({ "autoWidth": autoWidth, "columns": aryColumns, "destroy": true, "dom": '<ip<t>ip>', "order": aryOrder, "paging": paging, responsive: true, "rowGroup": aryRowGroup, rowReorder: { selector: 'td:nth-child(2)' }, "scrollCollapse": scrollCollapse, "scrollResize": scrollResize, "scrollY": scrollY, "searching": searching });
  },

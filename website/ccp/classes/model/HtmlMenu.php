...
class HtmlMenu extends HtmlBase {
  ...
  public function getHtmlRoot() {
    ...
    //     $output .= str_repeat(string: " ", times: 2) . "<span style=\"color: white; font-size: 1.25em;\">\n";
//     $output .= str_repeat(string: " ", times: 3) . "<svg width=\"35\" height=\"35\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"#ffffff\" stroke-width=\"2\" stroke-linecap=\"butt\" stroke-linejoin=\"arcs\">\n";
//     $output .= str_repeat(string: " ", times: 4) . "<path d=\"M19 12H6M12 5l-7 7 7 7\"/>\n";
//     $output .= str_repeat(string: " ", times: 3) . "</svg>\n";
//     $output .= str_repeat(string: " ", times: 2) . "</span>\n";
//     $output .= str_repeat(string: " ", times: 2) . "<span style=\"color: white; font-size: 1.25em;\">Menu</span>\n";
  ...
  public function getHtml(bool $parent, int $counter) {
    ...
    foreach ($this->items as $item) { // $menu is HtmlLink or HtmlMenu object
      if (get_class(object: $item) == "ccp\classes\model\HtmlLink") {

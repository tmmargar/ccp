    ...
    switch ($dataName) {
      ...
      case "tournamentsWonByPlayerId":
        $query =
          ...
          "t.tournament_addon_chip_count AS 'chips ', t.tournament_rake, l.location_map AS mapHide, l.location_map_link AS map, IFNULL(ec.enteredCount, 0) AS enteredCount, p.player_active_Flag, t.special_type_id, st.special_type_description AS std, " .
